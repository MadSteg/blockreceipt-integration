...
export function Avatar({ seed, size=160, rounded=true, allowDownload=false }:{
  seed: string; size?: number; rounded?: boolean; allowDownload?: boolean;
}) {
  const svg = React.useMemo(()=>avatarSVG(seed, size),[seed,size]);
